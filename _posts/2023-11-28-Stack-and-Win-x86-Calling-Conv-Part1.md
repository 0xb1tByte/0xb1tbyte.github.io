...
## Stack Instructions: 
نتحدّث هنا بالطبع عن تعليمات `Assembly` تؤثر على الـ `Stack` وبنيته 
### `PUSH` 
...
هذه التعليمة تتيح لنا **نداء دالة** ومن ناحية الـ `Stack` سيتم **إضافة** العنوان الخاص بالـ **السطر التالي** أو **العملية التالية** في البرنامج والتي يفترض تنفيذها بعدما اكتمال نداء الدالة 
...
راجَع هذه المقالة [مُصطفى](https://twitter.com/5yx) ، فشكرًا جزيلًا له
  
</div>

<div dir="rtl" class="callout callout-info" markdown="span">
